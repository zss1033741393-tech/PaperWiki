...
- [[../concepts/compositional-executable-orchestration|Compositional Executable Orchestration]]
- [[../concepts/localized-counterfactual-credit-assignment|Localized Counterfactual Credit Assignment]]
- [[../concepts/sparse-credit-assignment|Sparse Credit Assignment]]
- [[../concepts/executable-orchestration-specification|Executable Orchestration Specification]]
- [[../concepts/role-capacity-dependency-co-design|Role-Capacity-Dependency Co-Design]]
- [[../methods/lemon|LEMON]]
- [[../methods/grpo-group-relative-policy-optimization|GRPO (Group-Relative Policy Optimization)]]
- [[../methods/counterfactual-field-mutation|Counterfactual Field Mutation]]
- [[../methods/teacher-spec-sft-warm-start|Teacher-Spec SFT Warm-Start]]
- [[../methods/node-level-execution-cache|Node-Level Execution Cache]]
- [[../datasets/gsm8k|GSM8K]]
- [[../datasets/multiarith|MultiArith]]
- [[../datasets/svamp|SVAMP]]
- [[../datasets/aqua|AQuA]]
- [[../datasets/mmlu|MMLU]]
- [[../datasets/humaneval|HumanEval]]
- [[../topics/llm-multi-agent-systems|LLM Multi-Agent Systems]]
...
- 13 个基线（3 单智能体 Vanilla/CoT/SC-CoT + 4 固定 MAS Chain/Tree/Complete/Random + 5 拓扑设计 AgentPrune/AgentDropout/G-Designer/ARG-Designer/OFA-MAS + 1 自适应 AFlow）（§4.1）。
...
- 原文 Appendix B「Limitations」自陈两点：RL 训练时间成本不小；评测限于文本推理/代码，未涉长程工具使用、多模态或交互环境。以下在此基础上补充审读判断：
...
- 各算力档位 worker 由 Appendix D.2 Table 3 指明：小/中/大 = Qwen2.5-7B/14B/32B-Instruct；仅 SFT teacher 模型未具名，完整复现另需该 teacher。
