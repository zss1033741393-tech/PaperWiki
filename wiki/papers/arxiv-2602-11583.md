...
[[reports/five-ws/report|The Five Ws of Multi-Agent Communication: Who Talks to Whom, When, What, and Why -- A Survey from MARL to Emergent Language and LLMs report]]

## Related knowledge

- [[communication-as-action|Communication as Action]]
- [[five-ws-of-communication|Five Ws of Communication]]
- [[control-relevant-information-channel|Control-Relevant Information Channel]]
- [[wiki/concepts/emergent-language|Emergent Language]]
- [[protocol-grounding|Protocol Grounding]]
- [[partner-generalization|Partner Generalization]]
- [[static-and-dynamic-communication|Static and Dynamic Communication]]
- [[llm-marl-hybrid-communication|LLM-MARL Hybrid Communication]]
- [[dec-pomdp-with-communication|Dec-POMDP with Communication]]
- [[graph-based-message-passing|Graph-Based Message Passing]]
- [[attention-based-communication|Attention-Based Communication]]
- [[event-triggered-communication|Event-Triggered Communication]]
- [[information-bottleneck|Information Bottleneck]]
- [[emergent-discrete-protocols|Emergent Discrete Protocols]]
- [[multi-agent-debate|Multi-Agent Debate]]
- [[protocol-constrained-natural-language|Protocol-Constrained Natural Language]]
...
- [[google-research-football-grf|Google Research Football (GRF)]]
- [[hanabi|Hanabi]]
- [[overcooked-ai|Overcooked-AI]]
- [[melting-pot|Melting Pot]]
- [[referential-signaling-games|referential/signaling games]]
- [[embodied-grid-world-tasks|embodied grid-world tasks]]
- [[multi-agent-communication|Multi-Agent Communication]]
- [[multi-agent-reinforcement-learning|Multi-Agent Reinforcement Learning]]
- [[wiki/topics/emergent-language|Emergent Language]]
