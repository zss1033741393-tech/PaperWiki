...
- [[compositional-executable-orchestration|Compositional Executable Orchestration]]
- [[localized-counterfactual-credit-assignment|Localized Counterfactual Credit Assignment]]
- [[sparse-credit-assignment|Sparse Credit Assignment]]
- [[executable-orchestration-specification|Executable Orchestration Specification]]
- [[role-capacity-dependency-co-design|Role-Capacity-Dependency Co-Design]]
- [[lemon|LEMON]]
- [[grpo-group-relative-policy-optimization|GRPO (Group-Relative Policy Optimization)]]
- [[counterfactual-field-mutation|Counterfactual Field Mutation]]
- [[teacher-spec-sft-warm-start|Teacher-Spec SFT Warm-Start]]
- [[node-level-execution-cache|Node-Level Execution Cache]]
- [[gsm8k|GSM8K]]
