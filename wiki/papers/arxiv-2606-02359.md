...
[[reports/moc/report|MOC: Multi-Order Communication in LLM-based Multi-Agent Systems report]]

## Related knowledge

- [[multi-order-communication|Multi-Order Communication]]
- [[evidence-receptive-field|Evidence Receptive Field]]
- [[semantic-attenuation|Semantic Attenuation]]
- [[topological-message-ordering|Topological Message Ordering]]
- [[semantic-topological-merging|Semantic-Topological Merging]]
- [[structural-message-consolidation|Structural Message Consolidation]]
- [[training-free-multi-agent-inference|Training-free Multi-Agent Inference]]
- [[reverse-bfs-shortest-hop-collection|Reverse BFS shortest-hop collection]]
- [[far-to-near-prompt-linearization|Far-to-near prompt linearization]]
- [[sentence-embedding-cosine-similarity|Sentence embedding cosine similarity]]
- [[batch-wise-disjoint-pair-merging|Batch-wise disjoint pair merging]]
- [[small-llm-candidate-distillation|Small-LLM candidate distillation]]
- [[random-dag-and-g-designer-topology|Random DAG and G-Designer topology]]
- [[mmlu|MMLU]]
- [[mmlu-pro|MMLU-Pro]]
- [[gsm8k|GSM8K]]
- [[svamp|SVAMP]]
