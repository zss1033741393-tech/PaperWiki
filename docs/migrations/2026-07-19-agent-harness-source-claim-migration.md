...
原 18 条主张完成迁移后，主题于 2026-07-19 增补 arXiv:2604.18071《Architectural Design Decisions in AI Agent Harnesses》。该论文不是原报告主张的迁移目标，而是新的经验架构设计空间来源，因此保留上表“六份报告承接 18 条旧主张”的历史口径，并另行记录增量：

| 新来源 | 新增主张 | 独立报告落点 | 主题报告中的用途 | 状态 |
| --- | --- | --- | --- | --- |
| Architectural Design Decisions in AI Agent Harnesses | 70 个公共系统可沿子代理、上下文、工具、安全、编排五维比较；五种模式是设计组合中心而非成熟度排行榜 | `architectural-design-decisions-agent-harnesses/report.md` → “五维架构空间”“五种架构模式” | 在 T1—T4 成员测试之后回答“怎样设计和选择” | 已新增 |

增量完成后，主题报告导航与证据边界为七份独立报告；`human_confirmed` 仍保持 `false`。
